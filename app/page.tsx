        ...
        <main className="flex flex-col items-center justify-center px-3 sm:px-8 py-4 sm:py-20 relative z-10 min-h-full">
          <div className="relative w-full max-w-4xl">
            <div className="bg-[#F9DFDF] border-[3px] sm:border-[4px] border-black rounded-2xl sm:rounded-3xl p-4 sm:p-10 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] sm:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transform transition-transform duration-300">
              ...
              <div className="">
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 mb-4 sm:mb-6 md:mb-2">
                  <a href="/databases" className="group text-white cursor-pointer px-3 sm:px-6 md:px-12 py-3 sm:py-4 md:py-6 bg-[#FF6B9D] hover:bg-[#FF5A8C] active:bg-[#FF4979] border-4 hover:border-8 border-black rounded-xl sm:rounded-2xl md:rounded-3xl font-black text-xs sm:text-sm md:text-xl transition-all hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] sm:hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] active:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] sm:active:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] md:active:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] sm:active:translate-x-[2px] sm:active:translate-y-[2px] md:active:translate-x-[4px] md:active:translate-y-[4px] text-center transform hover:rotate-1 hover:scale-105 flex-1">
                  ...
                  <a href="/apis" className="group text-white cursor-pointer px-3 sm:px-6 md:px-12 py-3 sm:py-4 md:py-6 bg-[#A78BFA] hover:bg-[#977BEA] active:bg-[#876BDA] border-4 hover:border-8 border-black rounded-xl sm:rounded-2xl md:rounded-3xl font-black text-xs sm:text-sm md:text-xl transition-all hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] sm:hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] active:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] sm:active:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] md:active:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] sm:active:translate-x-[2px] sm:active:translate-y-[2px] md:active:translate-x-[4px] md:active:translate-y-[4px] text-center transform hover:-rotate-1 hover:scale-105 flex-1">
                    <div className="flex items-center justify-center gap-1 sm:gap-2 md:gap-3">
                      <div className="text-center">
          ...
          <div className="text-center">
            <div className="inline-block mt-10">
              <a href="https://github.com/drjayaswal/backend" className="text-black bg-[#F96E5B] inline-block px-2 sm:px-6 py-2 sm:py-4 hover:bg-[#F9DFDF] border-6 border-transparent hover:border-black rounded-3xl font-black text-xs sm:text-lg hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] sm:hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] active:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] sm:active:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-all active:translate-x-[2px] active:translate-y-[2px] sm:active:translate-x-[3px] sm:active:translate-y-[3px] transform hover:scale-105">
